...
public class MutualFund extends Investment{
    ...
    */
    ...
    //Constructors used to create a object of MutualFund without any initializing values
	public MutualFund(){
	...
	*/
	//Creates a object of MutualFund and initialize values of share_symbol and share_name respectively
    ...
    */
    //Create a object of class MutualFund and initialize values of share_symbol, share_name and num_shares
	public MutualFund(String symbol, String name, int num_shares)
	{
		share_symbol = symbol;
		share_name = name;
    ...
    */
    //creates a object of class MutualFund and initialize values of share_symbol, share_name,share_price and num_shares
	public MutualFund(String symbol, String name, int num_shares, double share_price)
	{
		share_symbol = symbol;
		share_name = name;
		this.num_shares = num_shares;          //Uses this keyword to refer to the num_shares at class level
    ...
    */
    //creates a object of class MutualFund and initialize values of share_symbol, share_name,share_price,share_book_value and num_shares
	public MutualFund(String symbol, String name, int num_shares, double share_price, double share_book_value)
	{
		share_symbol = symbol;
		share_name = name;
		this.num_shares = num_shares;               //Uses this keyword to refer to the num_shares at class level
